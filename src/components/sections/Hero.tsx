    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-6 mb-8 justify-center lg:justify-start">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm">{siteConfig.rating}/5 Rating</span>
              </div>
            </div>
          ...
          >
            {[
              { number: `${siteConfig.yearsInBusiness}+`, label: "Years Experience" },
              { number: `${siteConfig.propertiesCleaned.toLocaleString()}+`, label: "Properties Cleaned" },
              { number: `${siteConfig.satisfactionRate}%`, label: "Satisfaction Rate" },
